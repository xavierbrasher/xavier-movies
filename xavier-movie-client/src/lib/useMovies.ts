...
const test_data: Movie_Props =  {
    ...
    movie_img_url:"https://upload.wikimedia.org/wikipedia/en/a/a0/Simpsons_final_poster.png",
    movie_description:"A movie where the simpson travel to different countries and experence a life. He takes a hike. He Lives a life. CROSS IT",
    movie_statistics: {
        dislikes: 5,
        likes: 100,
        stars: 4
